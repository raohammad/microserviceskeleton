...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "nicolas@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "nicolas API";

        private String description = "nicolas API documentation";
